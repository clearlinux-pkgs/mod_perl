...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) AB34BA0040E92ECE' gpg.status
%setup -q -n mod_perl-2.0.13
cd %{_builddir}/mod_perl-2.0.13
%patch -P 1 -p1
pushd ..
cp -a mod_perl-2.0.13 buildapx
popd
...
cp %{_builddir}/mod_perl-%{version}/Apache-Reload/LICENSE %{buildroot}/usr/share/package-licenses/mod_perl/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/mod_perl-%{version}/Apache-SizeLimit/LICENSE %{buildroot}/usr/share/package-licenses/mod_perl/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/mod_perl-%{version}/Apache-Test/LICENSE %{buildroot}/usr/share/package-licenses/mod_perl/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/mod_perl-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/mod_perl/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/mod_perl-%{version}/NOTICE %{buildroot}/usr/share/package-licenses/mod_perl/97c92650e1f9ce20b0b9e82b6effb9653f0d5541 || :
if test -f Makefile.PL; then
